...
import { Loader2, RefreshCw, Shield, WandSparkles } from 'lucide-react';
...
import { GenerateRandomSsnResultCard } from './generate-random-ssn-result-card';

type GenerationMode = 'single' | 'bulk';
type BulkCount = '10' | '50' | '100' | '200';

type RandomSsnFormProps = {
            ...
            <div className={cn('flex items-start gap-3.5 sm:items-center')}>
              ...
              <div className={cn('min-w-0 space-y-1 text-left')}>
                ...
                <CardDescription className={cn('text-sm leading-relaxed')}>
                  Choose generation mode and create random fake SSN data.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
