...
export const EMAIL_DEFAULT_LIMIT = USERNAME_DEFAULT_LIMIT;

const LIMIT_SELECT_ID = 'random-email-count';

type EmailLimitSelectProps = {
  value: string;
...
export function EmailLimitSelect({
  value,
  onValueChange,
  disabled,
  className,
}: EmailLimitSelectProps) {
  return (
    <div
      className={cn(
