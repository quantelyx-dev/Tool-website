      ...
      <motion.section
        ...
        <motion.div
          ...
          <p
            ...
            Have a question, found a bug, or just want to say hello? We read
            every message and will get back to you as soon as we can.
          </p>
        </motion.div>
      </motion.section>

      <ContactForm className={cn('mt-12 sm:mt-14 lg:mt-16')} />
    </div>
  );
}
