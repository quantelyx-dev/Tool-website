...
import { GenerateRandomUsernamesBreadcrumb } from '@/components/generate-random-usernames/generate-random-usernames-breadcrumb';
  ...
  return (
    <main className={cn('flex-1')}>
      <div className={cn('container mx-auto max-w-6xl px-4 pb-20 sm:px-6')}>
        <GenerateRandomUsernamesBreadcrumb />
